...
(function (root) {
  ...
  function makePrompt(context){
    ...
    const base=[
      ...
      "Nếu chưa đủ thông tin, chỉ trả JSON dạng {\"status\":\"NEED_INFO\",\"questions\":[\"câu hỏi\",\"câu hỏi\",\"câu hỏi\"]} với 3–6 câu ngắn. Nếu đủ, chỉ trả JSON dạng {\"status\":\"PLAN_READY\",\"mainQuest\":{\"title\":\"string\",\"description\":\"string\"},\"weeklyQuests\":[{\"title\":\"string\",\"description\":\"string\",\"target\":4,\"mainQuest\":\"string\"}],\"tasks\":[{\"title\":\"string\",\"description\":\"string\",\"category\":\"string\",\"taskType\":\"daily|weekly|recurring|one_time\",\"target\":1,\"period\":\"day|week|month\",\"preferredTime\":\"morning|daytime|evening|any\",\"tags\":[\"SI\"],\"difficulty\":\"Easy|Normal|Hard|Epic\",\"energyRole\":\"focus|movement|recovery|connection|reflection\",\"mainQuest\":\"string\",\"weeklyQuest\":\"string\",\"reason\":\"string\"}]}. Các mảng không có dữ liệu vẫn dùng []. Mỗi Task cần đủ các trường trên.",
