...
(function (root) {
  ...
  function makePrompt(context){
    ...
    return[
      "Bạn là AI lập kế hoạch Daily Task cho ứng dụng Life RPG. Dựa trên hồ sơ bên dưới, hãy tạo 3, 6, 9, 12, 15 hoặc 18 Task (tối đa 20/ngày), chia thành các nhóm liên tiếp, mỗi nhóm đúng 3 Task.",
      "Chỉ trả JSON hợp lệ, không markdown, theo schema:",
      '{"mainQuest":{"title":"...","description":"..."},"weeklyQuests":[{"title":"...","description":"...","target":4,"mainQuest":"..."}],"tasks":[{"title":"...","description":"...","category":"...","tags":["SI","EN","YouTube"],"difficulty":"Normal","energyRole":"focus|movement|recovery|connection|reflection","mainQuest":"...","weeklyQuest":"...","reason":"..."}]}',
